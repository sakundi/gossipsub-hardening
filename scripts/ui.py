...
class ConfigPanel(object):
    ...
    def __init__(self):
        ...
        w = Bunch(
            ...
            node_counts=Bunch(
                total=widgets.IntText(description="Total number of nodes", disabled=True),
                ...
                attacker=widgets.IntText(description="Number of attacker nodes", value=0),
            ...
            pubsub=Bunch(
                ...
                degree_hi=widgets.IntText(description='D_hi: mesh degree upper bound', value=12),
                degree_score=widgets.IntText(description='D_score: peers to select by score', value=4),
                degree_lazy=widgets.IntText(description='D_lazy: lazy propagation degree', value=6),
        ...
        # wire up node count sliders to update total node count
        sum_values(w.node_counts.total, w.node_counts.publisher, w.node_counts.lurker, w.node_counts.attacker)
